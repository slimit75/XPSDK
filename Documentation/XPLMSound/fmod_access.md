...
```cpp
XPLM_API FMOD_RESULTXPLMStopAudio(
...
```cpp
XPLM_API FMOD_RESULTXPLMSetAudioPosition(
                         FMOD_CHANNEL*        fmod_channel,
...
```cpp
XPLM_API FMOD_RESULTXPLMSetAudioFadeDistance(
                         FMOD_CHANNEL*        fmod_channel,
...
```cpp
XPLM_API FMOD_RESULTXPLMSetAudioVolume(
                         FMOD_CHANNEL*        fmod_channel,
                         float                source_volume
                    );
```
...
```cpp
XPLM_API FMOD_RESULTXPLMSetAudioPitch(
                         FMOD_CHANNEL*        fmod_channel,
...
```cpp
XPLM_API FMOD_RESULTXPLMSetAudioCone(
                         FMOD_CHANNEL*        fmod_channel,
                         float                inside_angle,
                         float                outside_angle,
